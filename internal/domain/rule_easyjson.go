...
func easyjsonF1a92ff2DecodeGoOctolabOrgEcosystemClickInternalDomain(in *jlexer.Lexer, out *Rule) {
...
func easyjsonF1a92ff2EncodeGoOctolabOrgEcosystemClickInternalDomain(out *jwriter.Writer, in Rule) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Description != "" {
...
func (v Rule) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF1a92ff2EncodeGoOctolabOrgEcosystemClickInternalDomain(&w, v)
...
func (v *Rule) UnmarshalJSON(data []byte) error {
	...
	easyjsonF1a92ff2DecodeGoOctolabOrgEcosystemClickInternalDomain(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Rule) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF1a92ff2DecodeGoOctolabOrgEcosystemClickInternalDomain(l, v)
}
