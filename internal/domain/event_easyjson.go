...
func easyjsonF642ad3eDecodeGoOctolabOrgEcosystemClickInternalDomain(in *jlexer.Lexer, out *RedirectEvent) {
...
func easyjsonF642ad3eEncodeGoOctolabOrgEcosystemClickInternalDomain(out *jwriter.Writer, in RedirectEvent) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v RedirectEvent) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF642ad3eEncodeGoOctolabOrgEcosystemClickInternalDomain(&w, v)
...
func (v *RedirectEvent) UnmarshalJSON(data []byte) error {
	...
	easyjsonF642ad3eDecodeGoOctolabOrgEcosystemClickInternalDomain(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *RedirectEvent) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF642ad3eDecodeGoOctolabOrgEcosystemClickInternalDomain(l, v)
}
func easyjsonF642ad3eDecodeGoOctolabOrgEcosystemClickInternalDomain1(in *jlexer.Lexer, out *RedirectContext) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF642ad3eEncodeGoOctolabOrgEcosystemClickInternalDomain1(out *jwriter.Writer, in RedirectContext) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Cookies) != 0 {
...
func (v RedirectContext) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF642ad3eEncodeGoOctolabOrgEcosystemClickInternalDomain1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *RedirectContext) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonF642ad3eDecodeGoOctolabOrgEcosystemClickInternalDomain1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *RedirectContext) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF642ad3eDecodeGoOctolabOrgEcosystemClickInternalDomain1(l, v)
}
func easyjsonF642ad3eDecodeGoOctolabOrgEcosystemClickInternalDomain2(in *jlexer.Lexer, out *Option) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF642ad3eEncodeGoOctolabOrgEcosystemClickInternalDomain2(out *jwriter.Writer, in Option) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Option) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF642ad3eEncodeGoOctolabOrgEcosystemClickInternalDomain2(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Option) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonF642ad3eDecodeGoOctolabOrgEcosystemClickInternalDomain2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Option) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF642ad3eDecodeGoOctolabOrgEcosystemClickInternalDomain2(l, v)
}
