...
func (*ReadLogRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_event_a55f78e262f85767, []int{0}
}
...
func (*ReadLogResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_event_a55f78e262f85767, []int{1}
}
...
func (*ListenLogRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_event_a55f78e262f85767, []int{2}
}
...
func (*ListenLogResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_event_a55f78e262f85767, []int{3}
}
...
func init() {
	...
	proto.RegisterType((*ListenLogRequest)(nil), "ListenLogRequest")
	proto.RegisterType((*ListenLogResponse)(nil), "ListenLogResponse")
}
...
func (c *logClient) Read(ctx context.Context, in *ReadLogRequest, opts ...grpc.CallOption) (*ReadLogRequest, error) {
	...
	err := c.cc.Invoke(ctx, "/Log/Read", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *logClient) Listen(ctx context.Context, in *ListenLogRequest, opts ...grpc.CallOption) (Log_ListenClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Log_serviceDesc.Streams[0], "/Log/Listen", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("event.proto", fileDescriptor_event_a55f78e262f85767) }

var fileDescriptor_event_a55f78e262f85767 = []byte{
	// 135 bytes of a gzipped FileDescriptorProto
	,
}
